...
<body>
    ...
    <div class="container-fluid w-auto" >
     ...
     <form action="/adminregister" method="POST" enctype="multipart/form-data" class="bg-white shadow-lg">
     @csrf
     <div class="col-12 text-center">
        <img src="logo.jpeg" alt="" height="60" width="60">
        <span class="text-secondary bg-white" style="font-size: 20px;font-weight:bold;">Registration</span>
     </div>
