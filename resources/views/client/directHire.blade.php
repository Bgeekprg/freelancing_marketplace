...
<body>
      @include('navbar')
        ...
        <div class="container w-sm-100">
         ...
         <form action="/directHire/{{$fid}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row justify-content-lg-center justify-content-md-center ">
              ...
              <div class="col-lg-8 col-md-8 col-sm-12 form-group my-2">
                ...
                <input  value="{{old('order_title')}}" type="number" name="budget" id="" placeholder="budget price" class="form-control my-2">
                <span class="text-danger">
                  @error('budget_price')
                  {{$message}}
                  @enderror
              ...
              <div class="col-lg-8 col-md-8 col-sm-12 form-group my-3">
                <input  type="submit" value="Submit Project" class="btn btn-success form-control" class="form-control my-2">
              </div>
