    ...
    <div class="col-lg-4 col-sm-8 col-md-4" >{{--style="width:300px">--}}
      ...
      <div class="card mb-4 shadow" style="height:400px;">
        <div class="card-body text-center">
         ...
         <div class="mb-2">
            @php
                $data=DB::select('select skill_name from skills,freelancerskills where freelancerskills.skill_id = skills.skill_id and freelancer_id =? limit 5', [$fd->freelancer_id]);
                foreach ($data as $d) {
                if ($d==Null) {
                  echo "<span class='mx-1 bg-success text-light btn-sm'>Not provided</span>"; 
                }
                else{
                echo "<span class='mx-1 bg-success text-light btn-sm'>".$d->skill_name."</span>";
                }
            }
            @endphp
         </div>
